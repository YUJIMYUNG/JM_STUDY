...
//
//성적을 문의하려는 학생들의 번호가 담긴 정수 리스트 numbers와 가채점한 점수가
// 성적을 문의하려는 학생 순서대로 담긴 정수 리스트 our_score,
...
public class PCCE_NO6 {
    public String[] solution(int[] numbers, int[] our_score, int[] score_list) {
        int num_student = numbers.length; //학생 몇명인지
        String[] answer = new String[num_student]; //학생번호마다 동일하면 Same, 다르면 Different 담는 배열
